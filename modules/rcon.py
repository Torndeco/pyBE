...
# 10/05/2014 Copied over for use in pyBE + removed abstract parser code etc + disabled logger
...
COMMANDS_WITH_NO_RESPONSE = ('say', 'loadBans')
#COMMANDS_WITH_NO_RESPONSE = ('loadBans')
...
class BattleyeServer(Thread):
	...
	def __init__(self, host, port, password):
		...
		self.logger = logging.getLogger("BattleyeServer")
